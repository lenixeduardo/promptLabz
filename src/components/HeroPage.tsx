...
/* ── Flame SVG (no fire.jpeg uploaded — vector fallback) ── */
function FlameIllustration() {
  return (
    <svg width="52" height="60" viewBox="0 0 52 60" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path d="M26 6 C26 6 38 20 38 34 C38 42 32 46 26 46 C20 46 14 42 14 34 C14 20 26 6 26 6Z" fill="#F97316" />
      <path d="M26 22 C26 22 32 30 32 36 C32 40 29.3 42 26 42 C22.7 42 20 40 20 36 C20 30 26 22 26 22Z" fill="#FB923C" />
      <path d="M26 30 C26 30 29 34 29 37 C29 39 27.7 40 26 40 C24.3 40 23 39 23 37 C23 34 26 30 26 30Z" fill="#FDE68A" />
      <ellipse cx="26" cy="50" rx="10" ry="3.5" fill="#FED7AA" opacity="0.6" />
    </svg>
  )
}
