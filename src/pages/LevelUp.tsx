...
const CONFETTI = [
  { color: "#7CC79A", x: "8%",  delay: "0s",    dur: "3s",   size: 8,  rotate: 20  },
  { color: "#FFD166", x: "18%", delay: "0.3s",  dur: "3.5s", size: 6,  rotate: -30 },
  { color: "#A8EDCA", x: "30%", delay: "0.1s",  dur: "2.8s", size: 10, rotate: 45  },
  { color: "#3E8E5E", x: "50%", delay: "0.5s",  dur: "3.2s", size: 7,  rotate: -15 },
  { color: "#FFD166", x: "65%", delay: "0.2s",  dur: "3.7s", size: 5,  rotate: 60  },
  { color: "#7CC79A", x: "78%", delay: "0.4s",  dur: "2.6s", size: 9,  rotate: -45 },
  { color: "#E8F9EF", x: "88%", delay: "0.6s",  dur: "3.4s", size: 6,  rotate: 30  },
  { color: "#FFD166", x: "42%", delay: "0.15s", dur: "4s",   size: 8,  rotate: -20 },
  { color: "#3E8E5E", x: "58%", delay: "0.7s",  dur: "2.9s", size: 5,  rotate: 55  },
  { color: "#A8EDCA", x: "12%", delay: "0.45s", dur: "3.1s", size: 7,  rotate: -35 },
  { color: "#FFD166", x: "25%", delay: "0.8s",  dur: "3.3s", size: 6,  rotate: 40  },
  { color: "#7CC79A", x: "72%", delay: "0.55s", dur: "2.7s", size: 8,  rotate: -10 },
  { color: "#E8F9EF", x: "35%", delay: "0.9s",  dur: "3.6s", size: 5,  rotate: 25  },
  { color: "#3E8E5E", x: "93%", delay: "0.25s", dur: "3.0s", size: 7,  rotate: -50 },
]
...
export default function LevelUp() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-between overflow-hidden bg-gradient-to-b from-white via-pageBgLight to-gradient-end px-6 py-10">
      ...
      <Sparkles className="absolute left-4 top-44 h-4 w-4 animate-twinkle text-[#FFD166]/70" style={{ animationDelay: "2.1s" }} />
      <Sparkles className="absolute right-12 top-56 h-3 w-3 animate-twinkle text-emerald/40" style={{ animationDelay: "1.3s" }} />

      <div className="flex flex-1 flex-col items-center justify-center gap-6 text-center">
        {/* Header — slides in from top */}
        <h1
          className="animate-podium-rise text-4xl font-extrabold leading-tight text-primary-dark"
          style={{ animationDelay: "0s" }}
        >
          Novo Nível!
        </h1>

        {/* Mascot with glow — rises in after title */}
        <div className="animate-podium-rise" style={{ animationDelay: "0.1s" }}>
          <MascotGlow size={220}>
            <img
        ...
        <p
          className="animate-podium-rise text-sm font-semibold text-foregroundMuted"
          style={{ animationDelay: "0.15s" }}
        >
          Parabéns!
        </p>

        {/* Level badge — bouncy pop-in */}
        <div
          className="animate-level-badge-pop flex flex-col items-center gap-2"
          style={{ animationDelay: "0.25s" }}
        >
          <div
            className="flex h-20 w-20 flex-col items-center justify-center bg-primary-dark text-white shadow-lg"
        ...
        {/* Unlocked items card — staggered slide-in per item */}
        <div
          className="animate-podium-rise w-full max-w-sm rounded-2xl border border-stroke-light bg-white px-5 py-4 text-left shadow-sm"
      ...
      <div
        className="animate-podium-rise w-full max-w-sm pt-4"
