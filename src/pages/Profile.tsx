    ...
    <div className="min-h-screen bg-gradient-to-b from-[#EAF7EF] via-[#E0F3E7] to-white pb-28">
      ...
      <div className="mx-auto w-full max-w-[420px] px-5 pt-5">
        ...
        <button
          ...
          className="mb-3 flex w-full items-center gap-3 rounded-2xl border border-[#CDEAD8] bg-white p-4 shadow-sm transition-all hover:shadow-md active:scale-[0.98]"
        >
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#EAF7EF]">
        ...
        >
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#EAF7EF]">
            <Heart className="h-5 w-5 text-[#3E8E5E]" />
          </div>
          <div className="min-w-0 flex-1 text-left">
            <p className="text-sm font-bold text-[#1F2A24]">Meus Favoritos</p>
            <p className="text-xs text-[#6B9E7E]">Prompts, templates, notícias e trilhas</p>
          </div>
          <ChevronRight className="h-4 w-4 shrink-0 text-[#BFE3CC]" />
        </Link>
        ...
        <Link
          ...
          className="mb-3 flex w-full items-center gap-3 rounded-2xl border border-[#CDEAD8] bg-white p-4 shadow-sm transition-all hover:shadow-md active:scale-[0.98]"
        >
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-[#F5A623]/20 to-[#C67A00]/10">
            <Crown className="h-5 w-5 text-[#F5A623]" />
          </div>
          <div className="min-w-0 flex-1 text-left">
            <p className="flex items-center gap-1.5 text-sm font-bold text-[#1F2A24]">
              Premium
              <Sparkles className="h-3.5 w-3.5 text-[#F5A623]" fill="#F5A623" />
            </p>
            <p className="text-xs text-[#6B9E7E]">Desbloqueie IA ilimitada e conteúdo exclusivo</p>
          </div>
          <ChevronRight className="h-4 w-4 shrink-0 text-[#BFE3CC]" />
        </Link>
