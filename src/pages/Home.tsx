  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-[#EAF7EF] to-white pb-24">
      ...
      <div className="flex-1 px-4 py-5 flex flex-col gap-5">
        ...
        <Link
          to="/premium"
          className="flex items-center justify-between rounded-2xl bg-gradient-to-r from-[#2B5D3A] to-[#1E4B2E] px-5 py-4 shadow-md transition-all hover:-translate-y-0.5 hover:shadow-lg"
        >
