...
- [ ] MVP fechado: 3–5 funcionalidades principais (não 20)
...
Escolha algumas — não precisa todas:
...
- [ ] Pelo menos 5–10 testes úteis
- [ ] 2–3 testes de unidade (função/regra de negócio)
- [ ] 2–3 testes de integração (API + DB ou service)
- [ ] 1–2 testes de UI (fluxo de formulário/erro/sucesso)
...
- [ ] Roadmap (2–5 itens) mostrando visão e priorização
...
- [ ] Changelog de versões (v0.1, v0.2…)
